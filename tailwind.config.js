...
import "../styles/hello-animation.css";
...
function Landing() {
  ...
  useEffect(() => {
    // Start name animation after hello animation
    setTimeout(() => {
      setShowHello(false);
      setShowName(true);
    }, 4000);

    // Start typing animation after hello disappears
    setTimeout(() => {
      let currentIndex = 0;
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white new__bg">
      {showHello && (
        ...
        <div className="text-center">
          ...
          >
            <button
              ...
              className="px-8 py-3 text-lg font-medium text-white bg-black rounded-full 
