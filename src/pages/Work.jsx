  ...
  const projects = [
    {
      ...
      imageUrl: "/istockphoto-1480535737-612x612.jpg",
    },
    {
      title: "UnlockX",
    ...
    },
    {
      ...
      status: "Available Now",
      imageUrl: "/Troubleshooting-for-The-POS-System-Machine-Speaker.jpg",
    },
  ];
    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 lg:px-24 pt-15 pb-15 gap-8 md:gap-0">
